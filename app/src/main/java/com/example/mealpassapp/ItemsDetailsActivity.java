...
boolean isDeliver, delivery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName = ViewFoodItemActivity.itemName;
        sellerName = ViewFoodItemActivity.sellerName;
        sellerPic = ViewFoodItemActivity.sellerPic;
        itemPrice = ViewFoodItemActivity.price+"";
        itemId = ViewFoodItemActivity.itemId;
        ItDiscount = ViewFoodItemActivity.discount+"";
        ItPoints = ViewFoodItemActivity.points+"";
        points = Integer.parseInt(ViewFoodItemActivity.points+"");
        ItPic = ViewFoodItemActivity.pic;
        sellerId = ViewFoodItemActivity.sellerId;
        sellerToken = ViewFoodItemActivity.token;
        delivery = ViewFoodItemActivity.delivery;

        //Toast.makeText(this, itemName+"  "+sellerName+"  "+ItDiscount, Toast.LENGTH_LONG).show();
    ...
    private void BottomSheetFunction() {
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(ItemsDetailsActivity.this , R.style.BtoonSheetDialogTheme);
        ...
        increaseP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(q<=200){
                    ...
                    Toast.makeText(ItemsDetailsActivity.this, "Not greater than 200", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quan<1){
                    ...
                    AlertDialog.Builder confirmationBuilder = new AlertDialog.Builder(ItemsDetailsActivity.this);
                    ...
                    confirmationBuilder.setMessage("Are you sure to want place order ?  " + itemQuantity).setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            new MyFirebaseInstanceService().sendMessageSingle(ItemsDetailsActivity.this,sellerToken,"Alert", "New Item order", null);
