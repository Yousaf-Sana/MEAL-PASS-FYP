...
boolean isDeliver, delivery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName = UserActivity.itemName;
        sellerName = UserActivity.sellerName;
        sellerPic = UserActivity.sellerPic;
        itemPrice = UserActivity.price+"";
        itemId = UserActivity.itemId;
        ItDiscount = UserActivity.discount+"";
        ItPoints = UserActivity.points2+"";
        points = Integer.parseInt(UserActivity.points+"");
        ItPic = UserActivity.pic;
        sellerId = UserActivity.sellerId;
        sellerToken = UserActivity.token2;
        delivery = UserActivity.delivery;
    ...
    private void BottomSheetFunction() {
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(OrderRecommendedFoodActivity.this , R.style.BtoonSheetDialogTheme);
        ...
        increaseP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(q<=200){
                    ...
                    Toast.makeText(OrderRecommendedFoodActivity.this, "Not greater than 200", Toast.LENGTH_SHORT).show();
                }
            }
        });
